//var gmScriptName = 'groupmanalyticsV2-sg.js';
// Turbine code

function gmtagr()
{
    // set core tagr variables
	this.gmScriptName = 'groupmanalyticsV2-sg.js'; // This parameter needs to match the name of the JS file *as saved to the CDN*
	this.trackingDomain = 'sg-gmtdmp.gd2.mookie1.com'; // Use the tracking domain from the TAGr tag generated in the UI
    this.acid = 26; // Use the account ID (acid) from the tag generated in the UI
    this.inst = 'NA'; // Use the instance (inst) from the tag generated in the UI
    this.tagid = 296860969; // Use the tag id from the tag generated in the UI
	this.platformID = 'SZMK';
